...
public class Vote extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String card_number = request.getParameter("voter_card_number");
        ...
        String Password = "root";
         try{
            ...
            /*String table = "CREATE table vote(cardno varchar(255), party varchar(255))";
            stmt.execute(table);*/
            String insert = "INSERT into vote values('"+card_number+"','"+vote+"')";
            stmt.execute(insert);
