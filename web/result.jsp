...
<%
    ...
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/voterportal", "root", "root");
    Statement stmt = con.createStatement();
    ResultSet rs = stmt.executeQuery("select party,count(party) as c from vote group by party");
    int i = 0;

    while (rs.next()) {
        count.put(rs.getString("party"), rs.getString("c"));
    }
