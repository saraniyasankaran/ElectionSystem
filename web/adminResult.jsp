...
<%
    ...
    con= DriverManager.getConnection("jdbc:mysql://localhost:3306/voterportal", "root", "root");
    ...
    ResultSet resultSet = stmt.executeQuery("select party,count(party) as c from vote group by party");
    int i = 0;

    while (resultSet.next()) {
        count.put(resultSet.getString("party"), resultSet.getString("c"));
        countInt.put(resultSet.getString("party"), Integer.parseInt(resultSet.getString("c")));
    }
%>
<div class="limiter">
    <br><br><br><br>
            ...
            <form action="#" method="post" style="max-width:350px;margin:auto" >
                    ...
                    <div class="container" style="width: 700px">
                        ...
                        <table class="table-all" >
                            ...
                            <% while (rs.next()){
                                String  partyCode=rs.getString(1);
