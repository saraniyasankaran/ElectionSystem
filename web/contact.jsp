            ...
            <form action="Contact" method="post" style="max-width:350px;margin:auto">
                <center>
                    <div class="container">
                        ...
                        <input type="email" placeholder="Enter Email" name="cemail" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2, 3}$">

                        <input type="text" placeholder="Enter Your Message" name="cmessage"  required>
                        <hr>
