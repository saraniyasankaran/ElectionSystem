            ...
            <form action="AdminRegister" method="post" style="max-width:350px;margin:auto">
                <center>
                    <div class="container">
                        ...
                        <input type="text" placeholder="Enter Fullname" name="name1" required>


                        <input type="password" placeholder="Enter Password" name="password1" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2, 3}$">
                        <hr>
